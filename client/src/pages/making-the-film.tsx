...
export default function MakingTheFilm() {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-teal-500 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <h1 className="text-5xl font-display font-bold mb-6">Making the Film</h1>
          <p className="text-xl opacity-90 max-w-3xl mx-auto">
            The story behind "24 Days Without You" - from conception to screen, 
            meet the passionate team who brought this vital maternal health story to life.
          </p>
        </div>
      </section>
